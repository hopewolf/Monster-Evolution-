ssignment Task: Monster Evolution!
Game Overview:
...
“Skeletor”. The first three monsters are friendly, while the fourth and fifth type are not, and will attack you. In the dungeon there are 10 of each type of monster, except for “Skeletor” of which there is only 1, and it is located directly in front of the dungeon exit.
 ...
 * A special power modifier. This is a number that is added to battles each turn. Its value is 1 if monster type “Bugbear”, 2 if type “Platypie” or 3 if type “Emoo”. “Skeletor” Monster: The “Skeletor” monster (the boss monster) is represented by the following:
